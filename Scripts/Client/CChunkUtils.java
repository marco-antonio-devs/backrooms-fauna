 ...
 *
 * @deprecated Esta classe está obsoleta devido aos erros de nomenclatura. Utilize a classe ChunkUtils.
 * @author Marco Antônio Pereira Júnior.
 */
public class CChunkUtils
{
    ...
    public static int getSideBlockID(OH3LevelIntArray voxels, int x, int y, int z, int sideIndex)
    {
        ...
        {
            Console.log(voxels.get(rx, ry, rz));
